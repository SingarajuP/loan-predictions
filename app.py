...
def inputs():
    ...
    loanamount=st.number_input('Loan amount (K)',value=0)
    ...
    if st.button("Submit"):
        ...
        if appincome ==0 or loanamount==0:
            st.write("Please enter valid inputs. Applicant's income, loan amount cannot be zero")         
        else:
